namespace RealTime.UI
{
    ...
    internal class UserEventCreationWindow : UIPanel
    {
        ...
        public override void Start()
        {
            ...
            atlas = UITextures.GetTextureAtlas("Ingame");
            ...
            _totalPanel.atlas = UITextures.GetTextureAtlas("Ingame");
            ...
            _costLabel.atlas = UITextures.GetTextureAtlas("Ingame");
            ...
            _incomeLabel.atlas = UITextures.GetTextureAtlas("Ingame");
        ...
        public void SetUp(LabelOptionItem selectedData, ushort buildingID)
        {
            ...
            {
                var incentives = _linkedEvent.GetIncentives();
                ...
                Log.Info("Event capacity is " + _linkedEvent.GetCapacity().ToString() + ".");
                Log.Info("Successfully set up the UserEventCreationWindow.");
            }
            else
            {
                Log.Error("Linked event was invalid, or the building was 0!");
            }
        ...
        private void OptionItem_OnOptionItemChanged() => CalculateTotal();

        private void TicketSlider_eventValueChanged(UIComponent component, float value) => CalculateTotal();
        ...
        public void CalculateTotal()
        {
            if (_linkedEvent != null && _ticketSlider != null)
            {
                ...
                CityEventCosts costs = _linkedEvent.GetCosts();
                ...
                if (_ticketSlider != null)
                {
                    var sliderPanel = _ticketSlider.parent as UIPanel;
                    var sliderLabel = sliderPanel.Find<UILabel>("Label");
                    sliderLabel.text = string.Format(TranslationKeys.EventTicketCount, _ticketSlider.value);
                }
                ...
                if (_startTimeSlider != null)
                {
                    ...
                    var sliderLabel = sliderPanel.Find<UILabel>("Label");
                    sliderLabel.text = string.Format(TranslationKeys.EventStartTimeSlider, TimeOfDaySlider.getTimeFromFloatingValue(_startTimeSlider.value));
                }
                ...
                if (_startDaySlider != null)
                {
                    ...
                    var sliderLabel = sliderPanel.Find<UILabel>("Label");
                    sliderLabel.text = string.Format(TranslationKeys.EventStartDaySlider, _startDaySlider.value);
                }
        ...
        private void TranslateInfoString()
        {
            if (_linkedEvent != null)
            {
                ...
                string colourString = "<color#97ee00>{0}</color>";
                ...
                foreach (var wealth in wealthList)
                {
                    if (wealthString != "")
                    { wealthString += " & "; }
                ...
                foreach (var ageGroup in ageGroupList)
                {
                    if (ageGroupString != "")
                    { ageGroupString += " & "; }
                ...
                _informationLabel.text = string.Format(TranslationKeys.EventPopularityGenderInfo, genderString) + " ";
                _informationLabel.text += string.Format(TranslationKeys.EventPopularityWealthInfo, ageGroupString, wealthString, educationString);
            }
        }
        ...
        private void CreateEvent()
        {
            ...
            {
                var optionItems = _incentiveList.rowsData;
                var optionItemList = new List<IncentiveOptionItem>();
                ...
                var startTime = new DateTime(CityEventManager.CITY_TIME.Year, CityEventManager.CITY_TIME.Month, CityEventManager.CITY_TIME.Day);
                ...
                {
                    UIView.library.ShowModal<ExceptionPanel>("ExceptionPanel").SetMessage(TranslationKeys.EventCreationErrorTitle, TranslationKeys.EventCreationErrorDescription, true);
                    Log.Error("Couldn't create user event!");
                }
            }
        }
    }
