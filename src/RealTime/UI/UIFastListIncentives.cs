namespace RealTime.UI
{
    ...
    public class UIFastListIncentives : UIPanel, IUIFastListRow
    {
        ...
        public void Display(object data, bool isRowOdd)
        {
            if (data != null)
            {
                ...
                if (data is IncentiveOptionItem option && option.title != null && option.title != "" && background != null)
                {
                    ...
                    totalsPanel.atlas = UITextures.GetTextureAtlas("Ingame");
                    ...
                    costsReadout.atlas = UITextures.GetTextureAtlas("Ingame");
                    ...
                    returnsReadout.atlas = UITextures.GetTextureAtlas("Ingame");
        ...
        private void Translation_OnLanguageChanged()
        {
            costsLabel.text = TranslationKeys.EventItemBuy;
            returnsLabel.text = TranslationKeys.EventItemSell;
