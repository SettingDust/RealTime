...
namespace RealTime.GameConnection
{
        ...
        where T : struct
    {
        ...
        /// <summary>Gets the work/school building ID of the specified citizen.</summary>
        ...
        ushort GetWorkOrSchoolBuilding(ref T citizen);
        ...
        /// <param name="unitID">The ID of the not full unit in the hotel building to add the citizen to.</param>
        void SetHotel(ref T citizen, uint citizenId, ushort buildingId, uint unitID);
        ...
        /// <param name="citizenId">The citizen ID.</param>
        void ResetHotel(ref T citizen, uint citizenId);
